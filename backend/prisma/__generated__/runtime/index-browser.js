...
var Xe = (e, n, i) =>
	n in e
		? ne(e, n, { enumerable: !0, configurable: !0, writable: !0, value: i })
		: (e[n] = i);
var Ce = (e, n) => {
...
function Ve(e) {
	...
	function r(s) {
		...
		if (c === 'bigint')
			return s < 0 ? ((s = -s), (f.s = -1)) : (f.s = 1), se(f, s.toString());
		throw Error($ + s);
	}
	if (
		((r.prototype = h),
